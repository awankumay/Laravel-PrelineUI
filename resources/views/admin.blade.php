    ...
    <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-700 dark:text-neutral-400">Selamat datang di halaman admin dashboard.</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <!-- Card 1 -->
            <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow rounded-lg border border-gray-200 dark:border-neutral-700">
                <div class="p-5">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <svg class="h-6 w-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 dark:text-neutral-400 truncate">Total Users</dt>
            ...
            <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow rounded-lg border border-gray-200 dark:border-neutral-700">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 dark:text-neutral-400 truncate">Active Projects</dt>
            ...
            <div class="bg-white dark:bg-neutral-800 overflow-hidden shadow rounded-lg border border-gray-200 dark:border-neutral-700">
                <div class="p-5">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <svg class="h-6 w-6 text-yellow-600 dark:text-yellow-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="bg-white dark:bg-neutral-800 shadow rounded-lg border border-gray-200 dark:border-neutral-700">
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="flex items-center space-x-4">
                    <button type="button" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-neutral-800">
                        Primary Button
                    </button>
                    <button type="button" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-neutral-600 text-sm font-medium rounded-md text-gray-700 dark:text-neutral-200 bg-white dark:bg-neutral-700 hover:bg-gray-50 dark:hover:bg-neutral-600 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-neutral-800">
                        Secondary Button
                    </button>
                </div>
            </div>
