...
@section('content')
    <!-- 503 Icon -->
    <div class="mb-6">
        <div class="mx-auto flex items-center justify-center size-[120px] bg-linear-to-tr from-yellow-500 to-orange-600 rounded-full">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
            We're temporarily down for maintenance. We'll be back up and running soon!
        </p>
    </div>
