                            ...
                            <div
                                ...
                                <button id="hs-pro-anpjdi" type="button"
                                    ...
                                    <img class="shrink-0 size-6 rounded-full object-cover me-1"
                                        src="../assets/img/logo/hs.png" alt="Logo">
                                    Htmlstream
                                ...
                                <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-65 transition-[opacity,margin] duration opacity-0 hidden z-20 bg-white border border-gray-200 rounded-xl shadow-xl dark:bg-neutral-900 dark:border-neutral-700"
                                    ...
                                    <div class="p-1">
                                        <span
                                            class="block pt-2 pb-2 ps-2.5 text-sm text-gray-500 dark:text-neutral-500">
                                            Projects (2)
                                        </span>
                                        ...
                                        <div class="flex flex-col gap-y-1">
                                            ...
                                            <label for="hs-pro-anpjdi2"
                                                ...
                                                <img class="shrink-0 size-5 rounded-full object-cover"
                                                    src="../assets/img/logo/logo-short.png" alt="Logo">
                                            </label>
                                            <!-- End Item -->
                                        </div>
                                    </div>
                            ...
                            <div
                                ...
                                <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-60 transition-[opacity,margin] duration opacity-0 hidden z-20 bg-white border border-gray-200 rounded-xl shadow-xl dark:bg-neutral-900 dark:border-neutral-700"
                                    ...
                                    <div class="py-2 px-3.5">
                                        ...
                                        <div class="mt-1.5">
                                            <a class="flex justify-center items-center gap-x-1.5 py-2 px-2.5 font-medium text-[13px] bg-black text-white rounded-lg focus:outline-hidden disabled:opacity-50 disabled:pointer-events-none dark:bg-white dark:text-black"
                                                href="#">
                                                Upgrade to Pro
                                            </a>
                                        </div>
